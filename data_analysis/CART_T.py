...
def load_data():
    train_data = pd.read_csv(r'G:\20190426\zhouweiwei\mygit\blogApp\data_analysis\data\titanic\Titanic_Data-master\train.csv')
    test_data = pd.read_csv(r'G:\20190426\zhouweiwei\mygit\blogApp\data_analysis\data\titanic\Titanic_Data-master\test.csv')
    ...
    '''特征选择
        要找出有用的字段，去掉无用的字段
        1)无关的字段：passengerId,name(是谁活了，没有什么关系)，Ticket(船票号)，Cabin(有丢失，不要了)
    '''
    # print(train_data.info())
    ...
    train_labels = test_data['Survived']
